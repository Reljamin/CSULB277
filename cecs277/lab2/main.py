...
def weapon_menu():
    ...
    while (user_weapon == "N"):
        user_weapon = input()
        if user_weapon.upper() not in ["R", "P", "S", "B"]: #check input as a list of valid inputs
            user_weapon = "N"
    ...
    return user_weapon.upper() # returns user weapon
...
# return type void parameters int, int
# ----------------------------------------
